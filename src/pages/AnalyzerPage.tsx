...
export const AnalyzerPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-zinc-200 dark:border-zinc-800"><div><h1 className="text-xl sm:text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 flex items-center gap-2">Analyzer Workspace <span className="text-xs font-normal font-mono px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">Analysis Ready</span></h1><p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">Analyze Java, C, C++, and Python source without executing it.</p></div><div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 text-xs text-emerald-700 dark:text-emerald-300 shrink-0"><Info className="w-4 h-4 shrink-0" /><span>Static Analysis + Local AI</span></div></div>
